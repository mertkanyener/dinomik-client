...
export class ProfileComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.initForm();
    this.setFormValues();
    this.subsciption = this.utilService.imageChanged.subscribe(
      (image: Image) => {
  ...
  private setFormValues() {
    ...
    this.form.controls.spotify.setValue(this.user.spotify);
    this.image.dataUrl = this.user.image;
  }
